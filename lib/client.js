 ...
 * @property {"onyx"|"alloy"|"shimmer"|"echo"} [voice]
...
export class RealtimeClient extends RealtimeEventHandler {
  ...
  constructor({ url, apiKey, dangerouslyAllowAPIKeyInBrowser, debug } = {}) {
    ...
    this.defaultSessionConfig = {
      ...
      tool_choice: 'auto',
      temperature: 0.2,
      max_response_output_tokens: 2096,
    };
    this.sessionConfig = {};
    ...
    this.defaultServerVadConfig = {
      ...
      prefix_padding_ms: 400, // How much audio to include in the audio stream before the speech starts.
